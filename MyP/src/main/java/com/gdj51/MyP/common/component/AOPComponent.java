...
public class AOPComponent {
	...
	@Pointcut("execution(* com.gdj51.MyP..controller.ManagerController.*(..))")//ATConroller안에 있는 모든 메소드
	...
	@Pointcut("execution(* com.gdj51.MyP..controller.컨트롤러.*Insert(..))"
			+"|| execution(* com.gdj51.MyP..controller.컨트롤러.*Update(..))")//ATConroller안에 있는 모든 메소드
	public void memberCkAOP() {}
	
	@Around("memberCkAOP()")
	public ModelAndView ckAOP(ProceedingJoinPoint joinPoint) throws Throwable {//예외가 발생할 수 있어서 안전장치 걸어두자!
		ModelAndView mav = new ModelAndView();
