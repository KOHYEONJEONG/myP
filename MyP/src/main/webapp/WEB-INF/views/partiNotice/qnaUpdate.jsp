...
<body>
	...
	<form action="QnaDetail" id="backForm" method="post">
		<!-- 전 화면에서 넘어온 페이지 정보 -->
		<input type="hidden" id="no" name="no" value="${data.QNA_NUM}" /> <input
			type="hidden" id="page" name="page" value="${page}" />
		<!-- 전 화면에서 넘어온 검색 정보 -->
		...
		<div class="main_wrap">
			...
			<div class="right_area">
				<form action="#" id="actionForm" method="post">
					<input type="hidden" name="no" value="${data.QNA_NUM}" /> <input
						type="hidden" name="answercon" value="${data.ANSWER_CON}" /> <input
						type="hidden" name="ckval" id="ckval" />
                    ...
                    <hr /> -->
						<input type="text" class="input_box" placeholder="${data.TITLE}"
							id="title" name="title" />
						<hr />
						<div class="con">
						...
						<div class="checkbox_box">
							<span>비공개</span> <input type="checkbox" id="checkbox"
								onClick="check(this)" />
						</div>
	...
	<footer>
		<div id="footer_box">
			<ul>
				<li>서울시 금천구 가산동 가산디지털로2로 115 대륭테크노타운3차 1109호 1호 TEL :
					02-2108-5900 Email : TRAFFICTEAMj@goodee.co.kr</li>
